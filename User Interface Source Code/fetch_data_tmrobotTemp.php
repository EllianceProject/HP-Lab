...
$query = '
SELECT latest_robot.temperature, machine_parameters.towerlight_status
FROM (SELECT temperature FROM "Main".hp_tm_robot ORDER BY id DESC LIMIT 1) AS latest_robot
