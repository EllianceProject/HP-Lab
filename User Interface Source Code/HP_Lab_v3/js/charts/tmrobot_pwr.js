...
//   "use strict";
//   $.ajax({
//       url : "http://localhost:81/template/HP_lab_local/fetch_data_tmrobotPwr.php",
//       type : "GET",
...
//         var target = document.getElementById('tmrobotPwr'); // your canvas element
...
( function ( $ ) {
  ...
  //       }
      ...
      var opts1 = {
        ...
        staticLabels: {
            font: "8px sans-serif",  // Specifies font
            labels: [0, 5000],  // Print labels at these values
            color: "#fff",  // Optional: Label text color
            fractionDigits: 0  // Optional: Numerical precision. 0=round off.
          },
        pointer: {
        ...
        // pressure graph plotting
        var target = document.getElementById('tmpower'); // your canvas element
        var gauge = new Gauge(target).setOptions(opts1); // create sexy gauge!
        gauge.maxValue = 5000; // set max gauge value
        gauge.setMinValue(0);  // Prefer setter over gauge.minValue = 0
        gauge.animationSpeed = 32; // set animation speed (32 is default value)
        gauge.set(1000); // set actual value // call the variable assigned
        target.title = gauge.value;
